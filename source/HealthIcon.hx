...
class HealthIcon extends FlxSprite
{
	...
	public function changeIcon(char:String) {
		if(this.char != char) {
			...
			if(Paths.fileExists('images/' + name + '.xml', IMAGE)) isAnimated = true;
			if(!isAnimated) {
			...
			animation.addByPrefix('default', 'default', 24);
			animation.addByPrefix('losing', 'losing', 24);
			animation.addByPrefix('winning', 'winning', 24);
