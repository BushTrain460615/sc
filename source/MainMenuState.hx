...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(-12, FlxG.height - 44, 0, "HaxeLua Engine version " + psychEngineVersion, 12);
			...
			if (controls.ACCEPT)
			{
				...
				else
				{
					new FlxTimer().start(0.1, function (tmr:FlxTimer) {
						FlxTween.tween(camGame, { zoom: 5 }, 3, { ease:FlxEase.quadInOut });
						FlxTween.tween(camGame, { angle: 360 }, 3, { ease:FlxEase.quadInOut });
					});
					selectedSomethin = true;
